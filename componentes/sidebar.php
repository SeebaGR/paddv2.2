<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="dashboard.php"> <img alt="image" src="https://www.origenmedios.cl/wp-content/uploads/2023/10/logo-origen-2023-sm2.png" class="header-logo" />
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">MENÚ PADD</li>
            <li class="dropdown active">
              <a href="dashboard.php" class="nav-link"><i data-feather="monitor"></i><span>Panel de Inicio</span></a>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown fondo"><i
                  data-feather="briefcase"></i><span>Área Comercial</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="clientes.php">Clientes</a></li>
                <li><a class="nav-link" href="#">Productos</a></li>
                <li><a class="nav-link" href="#">Medios</a></li>
                <li><a class="nav-link" href="#">Agencias</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="#">Contratos</a></li>
                <li><a class="nav-link" href="#">Soportes</a></li>
                <li><a class="nav-link" href="#">Campañas</a></li>
                <li><a class="nav-link" href="#">Temas</a></li>
                <li><a class="nav-link" href="#">Planes de Medios</a></li>
                <li><a class="nav-link" href="#">Órdenes de Compra</a></li>
              </ul>
            </li>
            <li class="dropdown">
